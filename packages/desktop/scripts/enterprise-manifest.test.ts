...
test("keeps the generated CHAI guide and manifest version aligned", async () => {
  ...
  expect(manifest.guideVersion).toBe("chai-1")
  expect(await guide.text()).toStartWith("# CHAI AI 사용 가이드\n")
