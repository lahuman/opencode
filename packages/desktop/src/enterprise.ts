...
export const ENTERPRISE_PROFILE = parseEnterpriseProfile({
  ...
  OPENCODE_ENTERPRISE_MODELS: import.meta.env.OPENCODE_ENTERPRISE_MODELS,
  OPENCODE_ENTERPRISE_DEFAULT_MODEL_ID: import.meta.env.OPENCODE_ENTERPRISE_DEFAULT_MODEL_ID,
