  ...
  return (
    <Drawer open={drawerOpen()} onOpenChange={setDrawerOpen} side="right">
      <Show when={settings.general.shouldDisplayTabsToast()}>
        <div
          class={`fixed ${enterprise() ? "bottom-14" : "bottom-5"} right-5 z-50 h-[240px] w-[192px] rounded-[8px] bg-v2-background-bg-base p-1 shadow-[var(--v2-elevation-floating)]`}
            ...
            <Show
              ...
              fallback={
                <>
                  ...
                  <p>
                    Start a new session in a tab, or open an existing session from any of your projects. Open a new tab
                    when you're starting something new, and close it when you're done.
                  </p>
                  <p>
                  ...
                  <p>
                    You'll find all your sessions and projects on the new Home screen. Selecting a session opens it in
                    a tab.
                  </p>
                  ...
                  <p>
                    The new design does not support Git Worktrees yet, it's coming soon. So if you'd prefer to continue
                    using the previous layout, you can switch between layouts in Settings. Just keep in mind that the
                    new layout will become permanent in a few weeks.
                  </p>
                </>
              }
            >
