    ...
    <div data-component="session-new-design" class="relative size-full overflow-hidden bg-v2-background-bg-deep ">
      <div class="absolute inset-x-0 top-[25.375%] flex justify-center px-6">
        <div class={NEW_SESSION_CONTENT_WIDTH}>
          {platform.enterprise ? (
            <CHAIWordmark class="h-auto w-full text-v2-background-bg-inverse" />
          ) : (
...
function CHAIWordmark(props: Pick<ComponentProps<"svg">, "class">) {
  const mask = createUniqueId()
  const maskGradient = createUniqueId()

  return (
    <svg
      data-component="chai-wordmark-v2"
    ...
    >
      <g opacity="0.6" mask={`url(#${mask})`}>
        <g opacity="0.16" fill="currentColor">
          <path d="M126 18H216V36H144V90H216V108H126V18Z" />
          <path d="M252 18H270V54H324V18H342V108H324V72H270V108H252V18Z" />
          <path d="M378 18H468V108H450V72H396V108H378V18ZM396 36V54H450V36H396Z" />
