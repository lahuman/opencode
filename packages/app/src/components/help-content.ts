export const CHAI_ONBOARDING = {
  ...
  drawer: {
    ...
    intro:
      "CHAI는 저장소의 맥락을 이해하고 필요한 변경을 구현한 뒤 결과를 근거로 검증하는 AI 코딩 작업공간입니다.",
    sections: [
    ...
    offline: "CHAI는 통제된 폐쇄망 환경을 위해 설계되며, 설정된 내부 AI 서비스만 사용합니다.",
    guide: "자세한 운영 기준은 도움말 메뉴의 CHAI AI 가이드에서 확인할 수 있습니다.",
  },
} as const
...
export function onboardingContent(enterprise: boolean) {
  if (enterprise) return CHAI_ONBOARDING
