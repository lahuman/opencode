export const dict = {
  ...
  "dialog.model.unpaid.viewMoreProviders": "عرض أكثر من 70 موفرًا آخر",
  ...
  "permission.approvalMode.title": "وضع الموافقة",
  "permission.approvalMode.ask": "طلب الموافقة",
  "permission.approvalMode.autoReview": "وافق نيابةً عني",
  ...
  "settings.section.enterprise": "Enterprise",
  "settings.skills.title": "Skills",
  "settings.skills.description": "Bundled offline skill packs available to the company portable app.",
  "settings.skills.source": "Source",
  "settings.skills.license": "License",
  "settings.skills.confirm": "Changing {{name}} restarts the local server and may interrupt active work. Continue?",
  "settings.skills.pending": "Restarting the local server…",
  "settings.skills.error.rolledBack": "The local server could not restart. The previous skill setting was restored.",
  "settings.skills.error.recoveryFailed": "The local server and rollback both failed. Restart the app to recover.",
  "settings.skills.error.generic": "The skill pack setting could not be changed.",
