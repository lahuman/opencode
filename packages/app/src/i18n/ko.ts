export const dict = {
  ...
  "dialog.model.unpaid.viewMoreProviders": "70개 이상의 공급자 보기",
  ...
  "permission.approvalMode.title": "승인 방식",
  "permission.approvalMode.ask": "승인 요청",
  "permission.approvalMode.autoReview": "나 대신 승인",
  ...
  "settings.section.enterprise": "엔터프라이즈",
  "settings.skills.title": "스킬",
  "settings.skills.description": "회사 포터블 앱에 오프라인으로 포함된 스킬 팩입니다.",
  "settings.skills.source": "원본",
  "settings.skills.license": "라이선스",
  "settings.skills.confirm": "{{name}} 설정을 변경하면 로컬 서버가 재시작되어 실행 중인 작업이 중단될 수 있습니다. 계속할까요?",
  "settings.skills.pending": "로컬 서버를 재시작하는 중…",
  "settings.skills.error.rolledBack": "로컬 서버를 재시작하지 못해 이전 스킬 설정으로 복원했습니다.",
  "settings.skills.error.recoveryFailed": "로컬 서버 재시작과 복구가 모두 실패했습니다. 앱을 재시작해 주세요.",
  "settings.skills.error.generic": "스킬 팩 설정을 변경하지 못했습니다.",
