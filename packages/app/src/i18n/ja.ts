export const dict = {
  ...
  "dialog.model.unpaid.viewMoreProviders": "70以上のプロバイダーを表示",
  ...
  "permission.approvalMode.title": "承認モード",
  "permission.approvalMode.ask": "承認を求める",
  "permission.approvalMode.autoReview": "代わりに承認",
