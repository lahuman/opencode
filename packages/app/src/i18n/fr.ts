export const dict = {
  ...
  "permission.approvalMode.title": "Mode d’autorisation",
  "permission.approvalMode.ask": "Demander l’autorisation",
  "permission.approvalMode.autoReview": "Approuver pour moi",
