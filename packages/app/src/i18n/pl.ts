export const dict = {
  ...
  "permission.approvalMode.title": "Tryb zatwierdzania",
  "permission.approvalMode.ask": "Poproś o zatwierdzenie",
  "permission.approvalMode.autoReview": "Zatwierdź za mnie",
