export const dict = {
  ...
  "ui.sessionTurn.status.preparing": "Preparing response",
  "ui.sessionTurn.status.waitingModel": "Waiting for model response",
  "ui.sessionTurn.status.responding": "Writing response",
  "ui.sessionTurn.status.working": "Working",
  "ui.sessionTurn.status.delayed": "Response delayed",
  "ui.sessionTurn.status.syncing": "Syncing status",
  "ui.sessionTurn.status.disconnected": "Connection lost — reconnecting",
  "ui.sessionTurn.status.waitingUser": "Waiting for your response",
  "ui.sessionTurn.status.stopping": "Stopping",
  "ui.sessionTurn.status.compacting": "Compacting session",
  ...
  "ui.permission.allowAlwaysScope":
    "Ces modèles seront autorisés pour toutes les sessions de ce répertoire jusqu’au redémarrage d’OpenCode.",
