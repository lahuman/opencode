export const dict = {
  ...
  "ui.sessionTurn.status.preparing": "응답 준비 중",
  "ui.sessionTurn.status.waitingModel": "모델 응답 대기 중",
  "ui.sessionTurn.status.responding": "답변 작성 중",
  "ui.sessionTurn.status.working": "작업 실행 중",
  "ui.sessionTurn.status.delayed": "응답 지연 중",
  "ui.sessionTurn.status.syncing": "상태 동기화 중",
  "ui.sessionTurn.status.disconnected": "연결 끊김 — 재연결 중",
  "ui.sessionTurn.status.waitingUser": "사용자 응답 대기 중",
  "ui.sessionTurn.status.stopping": "중지 중",
  "ui.sessionTurn.status.compacting": "대화 정리 중",
